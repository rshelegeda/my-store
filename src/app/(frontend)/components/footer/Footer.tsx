        ...
        <footer className={styles.footer}>
            <div className={styles.footerContent}>
                ...
                <div className={styles.contactInfo}>
                    ...
                    <p>Email: <a href="mailto:info@example.com" className={styles.contactLink}>info@example.com</a></p>
                    <p>Телефон: <a href="tel:+380XXXXXXXXX" className={styles.contactLink}>+380 (XX) XXX XX XX</a></p>
